...
public class PickerView extends View {
    ...
    // Speed of auto scrolling back to the center
    private static final float AUTO_SCROLL_SPEED = 10;

    // Alpha (its max is 255, range = max - min)
    ...
    private void drawText(Canvas canvas, int textColor, float offsetY, String text) {
        ...
        // draw text in center
        // mHalfHeight + offsetY = the center coordinate of text
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mScrollDistance > mHalfTextSpacing) {
                    if (!mCanScrollLoop) {
                        ...
                        // Move the end element to the first place
                        moveTailToHead();
                    }
                    ...
                    if (!mCanScrollLoop) {
                        ...
                        // Move the first element to the end place
                        moveHeadToTail();
                    }
                    mScrollDistance += mTextSpacing;
                }
    ...
    public void setDataList(List<String> list) {
        ...
        mDataList = list;
        // reset mSelectedIndex in case of overflow
        mSelectedIndex = 0;
        invalidate();
    }
    ...
    public void setSelected(int index) {
        ...
        if (mCanScrollLoop) {
            // when looping, the mSelectedIndex value is fixed to mDataList / 2
